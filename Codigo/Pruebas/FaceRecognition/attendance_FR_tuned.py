...
time_limit = 30.0                 # Limite de tiempo para tomar una participacion
...
with open(circuloPath, "r") as file:
    for line in file.readlines():
        ...
        alumni_list[num_alumni] = {"nombre":name, "asistencia": 0} # Dicicionario por alumno -> Nombre:[asistencia, conteo]
        num_alumni += 1
...
while True:
    ...
    if f_data_locations != []:                                # Si se detecta un rostro
        ...
        for face_encoding, (top, right, bottom, left) in zip(f_frame_codings, f_data_locations): # Comparamos el rostro encontrado con los rostros conocidos
            ...
            cv2.putText(frame, alumni_list[index]["nombre"], (left +3, bottom -3), font, 0.4, (255,255,255), 1)
    else:
...
print("Asistencia de alum: ", alumni_list)
